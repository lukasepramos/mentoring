...
var require = {
	app: {
		analytics: true,
		copyright: "2016 by Lukas",
		deployType: "development",
		description: "",
		guid: "99fd7c05-6468-40d6-9777-349c6a753ef2",
		id: "com.amaxnet.app01",
		name: "NovoProjeto",
		names: {},
		publisher: "Lukas",
		url: "",
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","57488b222b876e477d5cef3b");
	...
	p.setString("acs-oauth-secret-development","O9XLzvW6KLCBLA3TuMLErQq8tDf1jHB0");
	p.setString("acs-oauth-key-development","poT9kT7KB3CLGcyeyk9dMpQYNw1Rxger");
	p.setString("acs-api-key-development","epwoYJfgd7pVL01PMZADyJIlMzbgsrTX");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","834NSQh5qmZ2dUqtJx");
	...
	p.setString("acs-oauth-secret-production","JjHCng76UUbNK6VM5NBmBXRdItBO95wM");
	p.setString("acs-oauth-key-production","UJFMUcITSrbYaxwfDuj8T5e6or8Y6g14");
	p.setString("acs-api-key-production","XxqlzYpUqeIDZVbiE9L38qh7zYvE87LC");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","xQaQG4cYz8OHByhM2z");
	p.setString("appc-org-id","100109396");
	p.setString("appc-creator-user-id","d830e65d-346d-48f8-97bb-ee39e5323ec2");
});
